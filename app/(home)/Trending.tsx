  ...
  return (
    ...
    >
      <div className="z-0 relative w-full h-full">
        {/* for using fill u need relative and w-full h-full */}
        <Image
          fill
          alt="tech"
          src={post?.image}
    ...
    <section className="pt-3 pb-10">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm">
          ...
          architecto commodi dolore sit, repellat voluptatum sint ipsum voluptas
          ratione numquam?
        </p>
      </div>
      ...
      <p className="text-sm">
        ...
        alias aperiam praesentium aut sit? Optio sunt harum consequatur iste,
        quo inventore labore accusantium doloremque?
      </p>
    </section>
  );
};
